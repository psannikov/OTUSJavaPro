package ru.otus.pro.psannikov.configuration.db.controllers;

import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.web.bind.annotation.*;
import ru.otus.pro.psannikov.configuration.db.dtos.CreateOrUpdateTaskStatusDtoRq;
import ru.otus.pro.psannikov.configuration.db.entities.TaskStatus;
import ru.otus.pro.psannikov.configuration.db.services.rest.TaskStatusService;
