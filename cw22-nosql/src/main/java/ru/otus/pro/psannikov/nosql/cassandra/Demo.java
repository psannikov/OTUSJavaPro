package ru.otus.pro.psannikov.nosql.cassandra;

import lombok.val;
import ru.otus.pro.psannikov.nosql.cassandra.db.CassandraConnection;
import ru.otus.pro.psannikov.nosql.cassandra.db.PhoneRepositoryImpl;
import ru.otus.pro.psannikov.nosql.cassandra.model.Phone;
import ru.otus.pro.psannikov.nosql.cassandra.model.SmartPhone;
import ru.otus.pro.psannikov.nosql.cassandra.schema.CassandraPhonesSchemaInitializer;
