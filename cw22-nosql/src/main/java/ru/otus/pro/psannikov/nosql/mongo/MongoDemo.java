package ru.otus.pro.psannikov.nosql.mongo;

import ru.otus.pro.psannikov.nosql.domain.BookMongo;
import ru.otus.pro.psannikov.nosql.mongo.repository.BookRepository;
...
public class MongoDemo {
    ...
    private static String insertBook(BookMongo book, BookRepository bookRepository) {
